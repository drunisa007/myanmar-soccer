...
public class U_18 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v=inflater.inflate(R.layout.fragment_mnlthree, container, false);
        mrecyclerview = (RecyclerView) v.findViewById(R.id.fixtureu18);
        mdRef = FirebaseDatabase.getInstance().getReference().child("Fixu18");

...
public class TicketModelHorizontal {

    private String stdsection,stdname,stdadult,time,uid,name,email,matchname,matchaway,matchtype,homelogo,awaylogo,date;
    public TicketModelHorizontal(){

    }
    public TicketModelHorizontal(String stdsection, String stdname, String stdadult, String time, String uid, String name, String email, String matchname, String matchaway, String matchtype, String homelogo, String awaylogo,String date) {
